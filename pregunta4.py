...
class Polinomio(object):
    ...
    def dividir(polinomio1, polinomio2):
        ...
        resultado = Polinomio()
        resultadoAux = Polinomio()
        while(mayor.temino_mayor.info.termino >= menor.temino_mayor.info.termino) and (mayor.temino_mayor.info.valor >= menor.temino_mayor.info.valor):
            aux= Polinomio()
            nuevoValor = mayor.temino_mayor.info.valor/menor.temino_mayor.info.valor
            nuevoTermino = mayor.temino_mayor.info.termino - menor.temino_mayor.info.termino
            aux.agregar_termino(nuevoTermino,nuevoValor)
            mayor = mayor.restar(menor.multiplicar(aux))
            print(nuevoValor)
            resultadoAux.agregar_termino(nuevoTermino,nuevoValor)
            if mayor.temino_mayor is None:
                break
        return resultadoAux
